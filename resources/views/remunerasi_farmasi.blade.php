...
<div class="content" style="margin-bottom:5px;">
  <center>
    <form class="form-inline" method="POST" action="{{ route('remunerasi_farmasi_simpan') }}" style="margin-top: 5px; margin-bottom: 0;">
    @csrf
      <input type="hidden" name="id_remun" id="id_remun" value="{{ $remun }}">

      <label>Jasa Farmasi Asal</label>
      ...
      <label style="margin-left: 10px;">Jasa Farmasi Baru</label>
      <div class="input-prepend">
        <span class="add-on">Rp.</span>
  ...
  <table width="100%" id="tabel" class="table table-hover table-striped" style="font-size: 13px;">
    <thead>
      <tr>
        ...
        <th class="min" style="text-align: center;">Jasa Asal</th>
        <th class="min" style="text-align: center;">Jasa Baru</th>
      </tr>      
    </thead>
    <tbody id="rincian">
    </tbody>
...
@section('script')
  <script type="text/javascript">
    window.onload=function() {
      ...
      $.ajax({
        type : 'get',
        url : '{{ route("remunerasi_farmasi_jasa") }}',
