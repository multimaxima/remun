<table>
  <tr>
    <td colspan="23" style="font-weight: bold; font-size: 20px; text-align: center;">
  ...
  <tr>
    ...
    <th style="text-align: center; font-weight: bold;">PENYESUAIAN</th>
  ...
  <tr>
    ...
    <td style="text-align: right; background-color: #b9b9b9;"></td>
    <td style="text-align: right;">{{ number_format($remun->penyesuaian,2) }}</td>
  ...
  <tr>
    ...
    <td style="text-align: right;">{{ number_format($remun->r_penyesuaian,2) }}</td>
...
<table>
  <tr>
    ...
    <td colspan="2" style="font-weight: bold; text-align: center;">PENGEMBALIAN LANGSUNG STAF DIREKSI</td>
    <td colspan="2" style="font-weight: bold; text-align: center;">KELOMPOK ADMINISTRASI</td>
    <td rowspan="3" width="15" style="font-weight: bold; text-align: center;">PENYESUAIAN</td>
    <td colspan="2" style="font-weight: bold; text-align: center;">TOTAL PENDAPATAN INDEK</td>
    <td colspan="2" style="font-weight: bold; text-align: center;">JASA PELAYANAN MEDIS/PERAWAT SETARA</td>
    <td rowspan="3" width="15" style="font-weight: bold; text-align: center;">TAMBAHAN JASA</td>
    <td rowspan="3" width="15" style="font-weight: bold; text-align: center;">TOTAL JASA</td>
  ...
  <tr>
    ...
    <td align="right">{{ number_format($rinc->r_penyesuaian,2) }}</td>
    ...
    <td align="right">{{ number_format($rinc->alokasi_apotik,2) }}</td>
    <td align="right">{{ number_format($rinc->total_jasa,2) }}</td>
  ...
  <tr>
    ...
    <th style="font-weight: bold; text-align: right;">{{ number_format($jumlah->r_penyesuaian,2) }}</th>
    <th style="font-weight: bold; text-align: right;">{{ number_format($jumlah->total_indek + $remun->penyesuaian,2) }}</th>
    ...
    <th style="font-weight: bold; text-align: right;">{{ number_format($jumlah->alokasi_apotik,2) }}</th>
    <th style="font-weight: bold; text-align: right;">{{ number_format($jumlah->total_jasa,2) }}</th>
    <th style="font-weight: bold; text-align: right;">{{ number_format($jumlah->jasa_pelayanan + $remun->penyesuaian,2) }}</th>
