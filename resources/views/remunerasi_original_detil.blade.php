    ...
    <div class="row-fluid">
      <div class="span12">
        <div style="float: left;">
          <form class="form-inline" method="GET" action="{{ route('remunerasi_original_detil') }}" style="margin-top: 5px; margin-bottom: 0;">
          @csrf
        ...
        <form hidden method="GET" action="{{ route('remunerasi_original') }}" id="kembali">
        @csrf
        </form>
...
<div class="content">
  <div>
    <label style="font-size: 16px; font-weight: bold; text-align: center;">
      DATA ORIGINAL REMUNERASI PASIEN {{ strtoupper($remun->jenis) }}
      TANGGAL
